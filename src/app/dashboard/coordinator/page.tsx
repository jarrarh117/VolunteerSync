...
import { generateTask } from '@/ai/flows/task-generator-flow';
...
import { generateDataReport, type GenerateDataReportOutput } from '@/ai/flows/data-report-flow';
...
export default function CoordinatorDashboardPage() {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            const result = await generateDataReport({
